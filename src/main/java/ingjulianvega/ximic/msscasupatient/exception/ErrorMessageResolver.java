...
public class ErrorMessageResolver {
    ...
    private final PatientParameters patientParameters;
    ...
    public ApiError resolveException(final String key) {
        ...
        return ApiError.builder().code(patientParameters.getPrefix() + errorArr[0]).description(errorArr[1]).build();
    }

    private ApiError getApiGenericError() {
        final String message = "UNKNOWN ERROR";
        return ApiError.builder()
                .code(patientParameters.getPrefix() + "500:199")
                .description(message)
                .build();
    }
}
